...
static void keccak_inc_absorb(uint64_t *s_inc, uint32_t r, const uint8_t *m,
    ...
    while (mlen + s_inc[25] >= r) {
        ...
        KeccakF1600_StatePermute33(s_inc);
    }
...
void cshake128_simple_absorb(shake128ctx *state, uint16_t cstm, const uint8_t *in, size_t inlen)
{
  ...
  KeccakF1600_StatePermute33(state->ctx);
 ...
 **************************************************/
void shake128_absorb33(shake128ctx *state, const uint8_t *input, size_t inlen)
{
#ifdef PROFILE_HASHING
  uint64_t t0 = hal_get_time();
#endif
 ...
 **************************************************/
void shake128_squeezeblocks33(uint8_t *output, size_t nblocks, shake128ctx *state)
{
#ifdef PROFILE_HASHING
  uint64_t t0 = hal_get_time();
#endif
 ...
 *              - size_t inlen:         length of input in bytes
 **************************************************/
void shake25633(uint8_t *output, size_t outlen,
